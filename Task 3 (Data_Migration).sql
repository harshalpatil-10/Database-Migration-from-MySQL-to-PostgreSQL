...
-- Only companies that have at least one job posting
...
-- LEFT JOIN
-- Purpose:
-- Fetch all companies and their job postings.
-- Companies without job postings will still appear,
-- but job-related columns will be NULL.
-- =====================================================
